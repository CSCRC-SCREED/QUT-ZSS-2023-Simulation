...
TemPCAP=rdpcap("/media/sf_sharing/Simulation testbed for Stage 3/Datasets/{}.pcapng".format(sys.argv[1]))

with open('/media/sf_sharing/Simulation testbed for Stage 3/Datasets/{}.csv'.format(sys.argv[1]), mode='w') as traffic:
