...
gooseListener(GooseSubscriber subscriber, void* parameter)
{
    ...
    uint64_t timestamp = GooseSubscriber_getTimestamp(subscriber); // Get UTC timestamp 
    //Add 10 hours time differences to local (+10) timestamp 
...
//############### store CBstval to local for control signal ##########################// 
    //Open File//
    fp=fopen("/home/ray/Desktop/Primary Plant/TripRecord/TripFromXFMR1.csv","w");   	
    if(fp==NULL) {
